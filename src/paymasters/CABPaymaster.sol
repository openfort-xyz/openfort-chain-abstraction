...
contract CABPaymaster is IPaymasterVerifier, BasePaymaster {
    ...
    function verifyInvoice(
        ...
        // proof is an opaque bytes object to potentialy support different proof systems
        // This paymasterVerifier supports Polymer proof system

        if (
            invoiceId
                == invoiceManager.getInvoiceId(
                    invoice.account, invoice.paymaster, invoice.nonce, invoice.sponsorChainId, invoice.repayTokenInfos
                )
        ) {
